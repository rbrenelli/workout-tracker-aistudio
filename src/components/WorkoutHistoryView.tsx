            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className="p-3.5 flex items-center justify-between gap-3 cursor-pointer hover:bg-[#111] transition-all select-none focus-visible:outline-none focus-visible:bg-[#111] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-zinc-600 rounded-t-xl"
                >
                  <div className="flex items-center gap-3">
